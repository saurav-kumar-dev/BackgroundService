package com.example.backgroundservice.materialarcmenu;
...
public class ArcMenu extends FrameLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    private void init(TypedArray attr) {
        ...
        mRippleColor = attr.getColor(R.styleable.ArcMenu_menu_ripple_color, getThemeAccentColor(getContext(), R.color.colorAccent));

        if (mColorStateList == null) {
            mColorStateList = ColorStateList.valueOf(getThemeAccentColor(getContext(), R.color.colorAccent));
        }
